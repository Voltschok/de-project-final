...
select
distinct hash(ha.hk_account_id, ht.hk_transaction_id) as hk_l_transaction_account,
ht.hk_transaction_id,
ha.hk_account_id ,
now() as load_dt,
's3' as load_src
from STV230530__DWH.h_accounts ha
left join STV230530__STAGING.transactions  as t on t.account_number_from = ha.account_number  
